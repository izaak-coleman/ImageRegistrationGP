...
extern volatile cfloat       AA[_Score][_Sedge]; // local operand array (ping)
extern volatile cfloat       BB[_Score][_Sedge]; // local operand array (pong)
extern volatile cfloat       Wn[_Sedge/2];       // local Wn twiddles array
